...
// Utils
import { createNewsBlog } from '../../utils/graphql/news_blogs_api';
        ...
        <section className="blog-form">
          <form onSubmit={this._handleSubmit}>
            ...
            <div className="news-link-container input-container">
              <input
                type="text"
                placeholder="https://www.news.com/article/10"
                onChange={ this._handleInputChange('news_link') }
                value={ this.state.news_link } />
              <p className="news-link-error error-message">
                You must provide an article link.
                {/* { error.news_link.message } */}
              </p>
            </div>
